...
export const Footer: React.FC<FooterProps> = ({ authStyle = false }) => {
  return (
    <footer
      className={
        authStyle
          ? "relative z-20 px-4 py-5 bg-white shadow-2xl mt-10 rounded-xl border-0"
    ...
    >
      <div className="max-w-7xl mx-auto text-center">
        <p
          className={
            authStyle
              ? "text-sm md:text-base font-bold tracking-wide text-purple-500 drop-shadow"
        ...
        >
          ...
          <a
            ...
            className={
              authStyle
                ? "text-purple-400 underline underline-offset-2 hover:text-purple-600 font-bold transition-colors"

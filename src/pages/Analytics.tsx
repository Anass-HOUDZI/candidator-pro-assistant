    ...
    <AppLayout>
      <div className="space-y-8">
        ...
        <div className="animate-fade-in">
          ...
          <p className="text-gray-600 mt-2 text-lg">Analysez vos performances et optimisez votre stratégie</p>
        </div>

        {/* Métriques principales avec animations */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: 'Candidatures Envoyées', value: metrics.candidatures, icon: Calendar, color: 'from-blue-500 to-blue-600', delay: '0ms' },
            { title: 'Entretiens Planifiés', value: metrics.entretiens, icon: Target, color: 'from-green-500 to-green-600', delay: '100ms' },
            { title: 'Offres Reçues', value: metrics.offres, icon: Award, color: 'from-purple-500 to-purple-600', delay: '200ms' },
            { title: 'Entreprises Ciblées', value: metrics.entreprisesCiblees, icon: Building, color: 'from-orange-500 to-orange-600', delay: '300ms' },
            { title: 'Taux de Réponse', value: `${metrics.tauxReponse}%`, icon: TrendingUp, color: 'from-pink-500 to-pink-600', delay: '400ms' },
            { title: 'Taux de Succès', value: `${metrics.tauxSucces}%`, icon: CheckCircle, color: 'from-teal-500 to-teal-600', delay: '500ms' }
          ].map((metric, index) => (
            <Card key={metric.title} className="animate-fade-in hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-white to-gray-50/50 border-0 shadow-lg" style={{ animationDelay: metric.delay }}>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <Card className="animate-fade-in shadow-xl border-0 bg-gradient-to-br from-white to-blue-50/30" style={{ animationDelay: '600ms' }}>
            <CardHeader>
          ...
          <Card className="animate-fade-in shadow-xl border-0 bg-gradient-to-br from-white to-purple-50/30" style={{ animationDelay: '700ms' }}>
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="animate-fade-in shadow-xl border-0 bg-gradient-to-br from-white to-red-50/30" style={{ animationDelay: '800ms' }}>
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              {alerts.length > 0 ? alerts.map((alert, index) => (
                ...
                } animate-fade-in`} style={{ animationDelay: `${800 + index * 100}ms` }}>
          ...
          <Card className="animate-fade-in shadow-xl border-0 bg-gradient-to-br from-white to-green-50/30" style={{ animationDelay: '900ms' }}>
            <CardHeader>
              <CardTitle className="text-lg font-bold text-gray-900 flex items-center gap-2">
            ...
            <CardContent className="space-y-3">
              {recentApplications.length > 0 ? recentApplications.map((app, index) => (
                <div key={app.id} className="p-3 rounded-lg bg-white border border-gray-100 hover:shadow-md transition-all duration-200 animate-fade-in" style={{ animationDelay: `${900 + index * 100}ms` }}>
          ...
          <Card className="animate-fade-in shadow-xl border-0 bg-gradient-to-br from-white to-indigo-50/30" style={{ animationDelay: '1000ms' }}>
            <CardHeader>
              <CardTitle className="text-lg font-bold text-gray-900 flex items-center gap-2">
            ...
            <CardContent className="space-y-4">
              {secteurData.length > 0 ? secteurData.map((item, index) => (
                <div key={item.name} className="animate-fade-in" style={{ animationDelay: `${1000 + index * 100}ms` }}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div 
                      ...
                      style={{ width: `${Math.min((item.candidatures / Math.max(...secteurData.map(s => s.candidatures), 1)) * 100, 100)}%` }}
                    />
                  </div>
        ...
        {/* Insights améliorés */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gradient-to-br from-blue-500 via-blue-600 to-purple-700 text-white animate-fade-in shadow-xl border-0" style={{ animationDelay: '1100ms' }}>
            <CardContent className="p-6">
          ...
          <Card className="bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 text-white animate-fade-in shadow-xl border-0" style={{ animationDelay: '1200ms' }}>
            <CardContent className="p-6">
              <h3 className="text-lg font-bold mb-3 flex items-center gap-2">
                🎯 Ciblage Stratégique
              </h3>
          ...
          <Card className="bg-gradient-to-br from-orange-500 via-pink-600 to-red-700 text-white animate-fade-in shadow-xl border-0" style={{ animationDelay: '1300ms' }}>
            <CardContent className="p-6">
              <h3 className="text-lg font-bold mb-3 flex items-center gap-2">
                🚀 Recommandations
              </h3>
